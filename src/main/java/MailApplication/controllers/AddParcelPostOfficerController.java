...
public class AddParcelPostOfficerController {
    ...
    @FXML private TextField svCompTextField;
    @FXML private TextField trackNumberTextField;
    ...
    public void handleOkBtnOnAction(ActionEvent event) throws IOException {
        ...
        String inputTypeMail = "ParcelPost";
        ...
        String inputsvComp = svCompTextField.getText();
        String inputtrackNumber = trackNumberTextField.getText();

        if(inputSendername.equals("") || inputRoomText.equals("") || inputsize.equals("")
                || inputOfficer.equals("") ||inputreceiverName.equals("") || inputtrackNumber.equals("")){
            ...
            if(!roomStr[0].matches("[A-B?]")){
                ...
                Thing addThing = new ParcelPost(inputTypeMail,"notReceivedYet",inputSendername, dateFormat.format(date),
                        inputOfficer,inputRoomText,inputreceiverName, "-",inputsize,inputsvComp, inputtrackNumber);
                things.add(addThing);
