...
public class AddLetterOfficerController {
    ...
    public void handleOkBtnOnAction(ActionEvent event) throws IOException {
        ...
        if(inputSendername.equals("") || inputRoomText.equals("") || inputsize.equals("") || inputOfficer.equals("")){
            ...
            if(!roomStr[0].matches("[A-B?]")){
                ...
                Thing addThing = new Thing(inputTypeMail,"notReceivedYet",inputSendername, dateFormat.format(date),
                        inputOfficer,inputRoomText,inputreceiverName, "-",inputsize);
                things.add(addThing);
